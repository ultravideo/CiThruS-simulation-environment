...
namespace FFmpegOut {
    ...
    class FFmpegPipe {
        ...
        public FFmpegPipe(string dir, string name, int width, int height, int framerate, Preset preset) {
            Filename = dir + DateTime.Now.ToString("yyyy_MMdd_HHmmss_") + name + GetSuffix(preset);
